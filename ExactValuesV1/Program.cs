                ...
                foreach (string kwItem in alKeywords)
                {
                    ...
                    try
                    {
                        ...
                        try //02-12-2020
                        {
                            ...
                            //if (el.Text.Split(':')[1].ToLower() == country.ToLower())//15-01-2021 commented
                            //{
                            //    goto LOCATION;
                            //}//end commented
                        ...
                        try //23-10-2020  added try block for country selection issue //27-11-2020
                        {
                            ...
                            IWebElement target = Wait.Until(ExpectedConditions.ElementToBeClickable(By.CssSelector("th.remove > material-icon:nth-child(1)"))); //05-03-2021
                            target.Click();
                        }
                        catch (ElementNotVisibleException ex)
                        {
                        ...
                        //if (driver.FindElements(By.CssSelector(".menu-lookalike")).Count > 0) //05-03-2021
                        {
                            ...
                            catch//27-11-2020
                            {
                                ...
                                try
                                {
                                    IWebElement labelinput = Wait.Until(ExpectedConditions.ElementToBeClickable(By.CssSelector("material-input.suggest-input")));
                        ...
                        try
                        {
                            try//27-11-2020 date-popup-button compact _ngcontent-jbl-71
                            {
                                //IWebElement dropdown = Wait.Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(".dropdown")));//15-01-2021 commented
                            ...
                            else if (values1[0].ToLower() == kwd.ToLower())
                            {
                                ...
                                for (int i = 48; i >= 1; i--)
                                {
                                    ...
                                    if (n++ < 12)
                                        try
                                        {
                                            yearValue += Convert.ToInt64(string.IsNullOrEmpty(values1[i + 13]) ? "0" : values1[i + 13]); // 11 in both places for old one   //08-11-2021
                                        }
                                        catch { }
                                }
